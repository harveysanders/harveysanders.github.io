...
/***/ function(module, exports, __webpack_require__) {
	...
	var _papaparse = __webpack_require__(165);
	...
	*/
	...
	var AppContainer = function (_React$Component) {
		...
		_createClass(AppContainer, [{
			key: 'handleCSVInput',
			value: function handleCSVInput(e) {
				var _this2 = this;
				...
				_papaparse2.default.parse(e.target.files[0], {
					...
					complete: function complete(results, file) {
						_this2.setState({
							results: getStipends(_utils2.default.cleanEtoData(results.data)),
							fileLoaded: true
						});
					}
				});
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(_ResultsContainer2.default, { results: this.state.results, fileLoaded: this.state.fileLoaded })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = UploadFileForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsContainer = function (_React$Component) {
		...
		_createClass(ResultsContainer, [{
			...
			value: function handleHeaderClick(sortBy) {
			...
			value: function render() {
				...
				// }
				var participants = _underscore2.default.sortBy(this.props.results, this.state.sortBy).map(function (participant, i) {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: '#', onClick: this.handleHeaderClick.bind(this, 'participantName') },
									'Participant Name'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: '#', onClick: this.handleHeaderClick.bind(this, 'cohort') },
									'Cohort'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: '#', onClick: this.handleHeaderClick.bind(this, 'totalCredits') },
									'Total Credits'
								)
							)
						)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = ResultsTableRow;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsTableHeader = function ResultsTableHeader(_ref) {
	...
	exports.default = ResultsTableHeader;
...
/***/ function(module, exports) {
	...
	utils.roundDownToHalf = function (num) {
	  var absNum = Math.abs(num);
	  var result = absNum * 10 % 10 >= 5 ? Math.floor(absNum) + 0.5 : Math.floor(absNum);
	  return num < 0 ? result * -1 : result;
	};

	utils.cleanEtoData = function (etoData) {
